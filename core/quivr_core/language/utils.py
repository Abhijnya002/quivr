...
def detect_language(text: str, low_memory: bool = True) -> Language:
    ...
    try:
        detected_language = gr_check(detected_language, "agent", "user_interface", site_id='site:sha256:cfe3720dfcc02b142d7567a50f176d09bcf02cc73c01b050159e17cb8228493f')
